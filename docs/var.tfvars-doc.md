...
oc_mirror_tarball           = "https://mirror.openshift.com/pub/openshift-v4/ppc64le/clients/ocp/stable/oc-mirror.tar.gz"
```
...
oc_mirror_tarball           = "https://mirror.openshift.com/pub/openshift-v4/ppc64le/clients/ocp/stable-4.20/oc-mirror.tar.gz"
```
For pre-release:
```
...
oc_mirror_tarball           = "https://mirror.openshift.com/pub/openshift-v4/ppc64le/clients/ocp-dev-preview/latest/oc-mirror.tar.gz"
```
